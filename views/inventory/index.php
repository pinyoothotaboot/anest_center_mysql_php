...
?>
<form name="inventory-form" method="post" action="<?php echo URL;?>inventory/select"> 
<div id="table-inventory">
	<table id="inventory-table">
		<thead>
            ...
            <th width="5%"><a class="label-tr">ส่งคืนพัสดุ</a></th>
        </thead>
        <tbody>
        	<?php
				foreach($this->selectdatatable[1] as $key => $value){
					...
					echo "<td ><a class=\"label-td\" href=\"".URL."inventory/inven/".$value['equipment_list_id']."\"> ส่งคืนพัสดุ</a></td>";
					echo "</tr>";
					}
				?>
        </tbody>
