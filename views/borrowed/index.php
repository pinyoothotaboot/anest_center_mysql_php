...
?>
<form name="borrowed-form" method="post" action="<?php echo URL;?>borrowed/select"> 
<div id="table-borrowed">
	<table id="borrowed-table">
		<thead>
            ...
            <th width="5%"><a class="label-tr">Borrowed</a></th>
        </thead>
        <tbody>
        	<?php
				foreach($this->selectdatatable[1] as $key => $value){
					...
					echo "<td ><a class=\"label-td\" href=\"".URL."borrowed/borrow/".$value['equipment_list_id']."\"> ยืมเครื่อง</a></td>";
					echo "</tr>";
					}
				?>
        </tbody>
