...
class Group extends Controller{
	...
	function index(){
		$data = array();
			...
			$this->view->css =array('group-content-table.css');
	...
	function addnew(){
			...
			$this->view->css =array('group-content.css');
	...
	function create(){
		$data = array();
		$this->model   = new Group_Model();
		$data['name']  = $this->model->secure($_POST['group-input']);
		$data['main']  = $this->model->secure($_POST['group-maintanance']);
