...
class Inventorydetail extends Controller{
	...
	function index(){
		...
		$data['page'] = 1;
		$_count=0;
		$this->model = new Inventorydetail_Model();
		$this->view->selectdatatable = $this->model->selectdatatable($data);
		$this->view->css =array('inventorydetail-content-table.css');
		$this->view->render('inventorydetail/index');
	}
	function select(){
		$data = array();
		$kkk = array();
